...
const GuestPostForm = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-8 space-y-6">
      <h2 className="text-2xl font-semibold text-center">Guest posts/link insert on Toolify</h2>

      <div className="text-center text-purple-600 text-lg font-medium mb-4">
        ...
        {creditOptions.map((option) => (
          <div
            ...
            className={`flex justify-between items-center p-4 rounded-lg cursor-pointer transition-colors ${
              option.amount === 1 ? "bg-purple-600 text-white" : "bg-gray-50"
            }`}
          >
      ...
      <div className="bg-purple-600 text-white p-4 rounded-lg flex justify-between items-center">
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-full bg-purple-500 hover:bg-purple-700"
        >
          -
        </button>
