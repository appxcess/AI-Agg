      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-2 px-4 py-3 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500 transition-colors"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {selectedTags.map((tag) => (
            <span
              key={tag.id}
              className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full border border-purple-500 text-sm cursor-pointer"
        ...
        <div>
          ...
          <textarea 
            ...
            rows="4"
            className="mt-1 block w-full rounded-md border-2 px-4 py-3 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500 transition-colors placeholder:text-gray-800"
          />
        </div> 
