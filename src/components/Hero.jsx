    ...
    <h1 className="text-4xl font-bold text-gray-800 mb-2">Discover The Best AI Websites & Tools</h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-6">
          <input
            ...
            className="px-4 py-2 w-full md:w-96 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button className="bg-blue-500 text-white px-5 py-2 rounded-md hover:bg-blue-700 transition">
            Search
          </button>
        </div>
      </div>
